...
readmit_weight = st.sidebar.slider("Weight of readmission in provider penalty", 0.0, 1.0, 0.20, 0.05)
...
with tab_dash:
    ...
    st.download_button("Download as CSV", csv_buffer.getvalue(), file_name="upi_results.csv", mime="text/csv")
